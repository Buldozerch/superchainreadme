...
3. **👛 Управление кошельками** - Просмотр и управление кошельками
4. **💰 Система финансирования** - Настройка и мониторинг OKX
5. **🌐 Сетевые инструменты** - Тестирование сетей и цен газа
6. **🔧 Управление прокси** - Замена плохих прокси
7. **⚙️ Настройки** - Конфигурация всех параметров
8. **🌍 Язык** - Переключение EN/RU
